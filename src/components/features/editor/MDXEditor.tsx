...
const MDXEditor = ({
  ...
  return (
    <div className='border-text-gray-lighter relative flex min-h-[640px] flex-1 flex-col rounded-xl border'>
      <div className='flex flex-wrap items-center justify-between gap-3 rounded-t-xl border-b border-gray-200 bg-gray-50 p-3'>
        <div className='flex flex-wrap items-center gap-3'>
          ...
          <div className='bg-text-gray-lighter h-5 w-px' />
      ...
      <textarea
        ...
        placeholder='請輸入文章內容（使用 MDX 語法）'
        className='flex-1 resize-none rounded-b-xl bg-white p-4 outline-none'
      />
    </div>
  );
};
