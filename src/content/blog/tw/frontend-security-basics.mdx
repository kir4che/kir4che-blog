...
> ⚠️ CSP 擋不住所有攻擊，它是最後一道防線，就算 XSS 防護有漏洞，CSP 還有機會補救。
...
> CORS 只是一種放寬機制，要伺服器明確授權，才允許跨源讀取，本身既不是攻擊也不是漏洞。
...
Access-Control-Max-Age: 86400  # preflight 結果可快取 1 天 (86400 秒)
```
